...
public class DetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        messageId = dataFromActivity.getString(ChatRoomActivity.MESSAGE_ID);
        ...
        deleteButton.setOnClickListener( clk -> {
            ...
            if(isTablet) { //both the list and details are on the screen:
                ...
                parent.deleteMessageId((int)id, messageId); //this deletes the item and updates the list
            ...
            else //You are only looking at the details, you need to go back to the previous list page
            {
                ...
                backToFragmentExample.putExtra(ChatRoomActivity.MESSAGE_ID, dataFromActivity.getString(ChatRoomActivity.MESSAGE_ID ));
